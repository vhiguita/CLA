...
@Component({
  selector: 'app-consolidated-vehicle-event',
  templateUrl: './consolidated-vehicle-event.component.html',
  styleUrls: ['./consolidated-vehicle-event.component.css']
})
export class ConsolidatedVehicleEventComponent implements OnInit {
	report: any= {};
  	event: any={}
  	eventos: any;
  	evento: any;
  ...
  ngOnInit() {
    ...
    this.paramPlate = '-1';
    this.paramDriver = '-1';
    this.paramTravel = this.manifestId;
  ...
  guardarRevisionCheck(): void {
    ...
    console.log('this.manifestId:_ ', this.manifestId)
    ...
    this.modalRev.close();
    this.obtenerEventos('-1', '-1', '-1', this.manifestId);
  }
